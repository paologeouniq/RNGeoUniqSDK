...
- (BOOL)getConsentStatus SWIFT_WARN_UNUSED_RESULT;
/// set privacy consent status
- (void)setConsentStatusWithIsGranted:(BOOL)isGranted;
/// show pop-up for privacy consent ask and set status
/// -returns: completion isGranted (Bool)
- (void)showConsentDialogAndSetWithCompletion:(void (^ _Nonnull)(BOOL))completion;
